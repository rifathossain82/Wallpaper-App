...
Color kPrimaryColor = const Color(0xFF2fad68);
Color kSecondaryColor = const Color(0xFF132332);
...
Color kHighlightColor = const Color.fromRGBO(47,173,104, .2);
...
Map<int, Color> materialColor = const {
  50: Color.fromRGBO(47,173,104, .1),
  100: Color.fromRGBO(47,173,104, .2),
  200: Color.fromRGBO(47,173,104, .3),
  300: Color.fromRGBO(47,173,104, .4),
  400: Color.fromRGBO(47,173,104, .5),
  500: Color.fromRGBO(47,173,104, .6),
  600: Color.fromRGBO(47,173,104, .7),
  700: Color.fromRGBO(47,173,104, .8),
  800: Color.fromRGBO(47,173,104, .9),
  900: Color.fromRGBO(47,173,104, 1),
};
